#!/bin/bash
# This shrink script has been adopted from https://github.com/Drewsif/PiShrink
# we have added functionality to make a unique uuid for the device upon first boot
...
echo "Making a unique name in the child database and hostname"
sudo -u postgres psql -d odm360 -f /home/pi/libre360/provisioning/dbase_child.sql
